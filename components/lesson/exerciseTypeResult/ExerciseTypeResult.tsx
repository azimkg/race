...
import { TEST_LETTER, WORDS } from 'helpers/lessonData';
    ...
    <div>
      <NavbarLesson />
      {
        type === 'word' ?
          ...
          :
          <TestResult accuracy={100 - (errorCount * 4) <= 0 ? 0 : 100 - (errorCount * 4)} time={TEST_LETTER[+test - 1].time} speed={40} title={'Тестовый урок'} text={letters} types={'time'} />
      }
    </div>
  );
};
