...
import cls from './testLesson.module.css';
...
const TestExersice: React.FC = () => {
  ...
  useEffect(() => {
    if (lesson === '5') {
      if (Math.ceil(progress) >= 105 || combinedString.length === currentIndex) {
